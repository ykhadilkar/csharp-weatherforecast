...
```json
{
  ...
  "bsGitRepository" : "github.com?owner=ykhadilkar&repo=csharp-weatherforecast"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [Sample->Sample, sample-app->csharp-weatherforeca...(truncated)]
...
┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ ┃ Debug Adding symbol repoUrl with value 'https://github.com?owner=ykhadilkar&repo=csharp-weatherforecast'
